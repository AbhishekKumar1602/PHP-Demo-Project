                ...
                <div class="col-md-3 col-sm-6 business_content">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Purchase <?php echo $row['Name'] ?> Starting From <span><?php echo $row['Price'] ?>$</span></p>
                        </div>
                    </div>
                </div>
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                ...
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright 2024 Gizmo E-Commerce | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
